...
class PdfContent {
    ...
    constructor(){
        ...
        this.AccountSummaryFooterPicture = "ET\nQ\nq\nq\nq\n1 0 0 1 450 -5175 cm\n2 0 0 2 0 0 cm\n0 0 m\n2100 0 l\n2100 -555 l\n0 -555 l\n0 0 l\nh\nW\nn\nq\nq\n2100 0 0 555 0 -555 cm\n/Im6 Do\nQ\nQ\nQ\nQ\nQ\nQ";
        this.AccountSummaryFooterNonPicture = "ET\nQ\nQ";
    ...
    get_account_summary(statement, period, types, pdfImage){
        ...
        // footer
        let footer = this.AccountSummaryFooterNonPicture;
        let exists = false;
        for (let key in pdfImage){
            if (pdfImage[key]['period']==period['period']){
                exists = true;break;
            }
        }
        if (exists){
            footer = this.AccountSummaryFooterPicture;
        }
    ...
    get_transactions(statement, period, page, types){
        ...
        if (page['page']==3){ // page 3 then with picture
            footer = this.TransactionsFooterPicture;
        }
